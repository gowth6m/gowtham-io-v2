...
export default function NavBar() {
    ...
    return (
        <div className="fixed w-full origin-top">
            ...
            {menuOpened && (
                <motion.div
                    className="md:invisible flex flex-col space-y-4 align-middle justify-end text-[var(--light-slate)] h-[100vh] w-[100vw] fixed top-0 left-0 bg-[var(--dark-navy)] px-4 py-8"
                    variants={variantNav}
                    initial="hidden"

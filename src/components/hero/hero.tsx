...
export default function Hero({ refAbout, refExperience, refProjects, refContact }: HeroProps) {
  ...
  }, [isAboutVisible, isExperienceVisible, isProjectsVisible, isContactVisible]);
    ...
    >
      <div className="flex flex-col md:gap-y-16">
        ...
        <div className="flex flex-col gap-y-2">
          ...
          <h2 className="text-[var(--lightest-slate)]">Co-Founder & CTO at Wavelink</h2>

...
const projects: ProjectModel[] = [
  ...
  },
  {
    ...
    stack: ['Next.js', 'React', 'Material UI', 'Node.js', 'TypeScript', 'React Flow', 'D3.js'],
    display: true,
  },
  // {
  //     year: 2023,
  ...
  // },
  {
    ...
    stack: ['Next.js', 'Tailwind', 'Stripe', 'Framer Motion', 'PayPal', 'MongoDB'],
    display: false,
  },
  // {
  //     year: 2022,
  ...
  },
  {
    ...
    stack: ['Python', 'PyTorch', 'Jupyter', 'YOLOv3', 'CNN', 'R-CNN', 'HICO', 'COCO'],
    display: false,
  },
  {
    year: 2020,
